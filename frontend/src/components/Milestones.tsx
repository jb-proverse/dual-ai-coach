          ...
          >
            <div className="flex items-start gap-4">
              ...
              <input 
                ...
                checked={!!m.complete} 
                onChange={() => toggle(i)} 
                className="w-5 h-5 text-indigo-600 rounded focus:ring-indigo-500 transition-all duration-200 hover:scale-110"
                    ...
                    {savedReflections[i] ? (
                      ...
                      <div>
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <p className="text-sm text-blue-700 font-medium">Add reflection</p>
                        </div>
                        <p className="text-sm text-blue-600 mb-2">How did this milestone go? What did you learn?</p>
                        <textarea 
                          value={getReflection(i)} 
                          onChange={e => updateReflection(i, e.target.value)}
                          className="w-full p-2 text-sm border border-blue-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-200 resize-none" 
